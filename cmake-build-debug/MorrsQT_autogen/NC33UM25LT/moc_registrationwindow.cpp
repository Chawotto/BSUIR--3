...
#include "../../../source/header/registrationwindow.h"
...
void RegistrationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->saveUser(); break;
        case 1: { userRole _r = _t->roleToEnum((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< userRole*>(_a[0]) = std::move(_r); }  break;
